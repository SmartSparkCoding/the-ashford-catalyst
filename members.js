window.CATALYST_MEMBERS = [
  {
    ...
    description: "Year 9 at Ashford School, a Computer Science, Maths and Physics enthusiast, Academic Scholar and swimmer. He helped create the idea during a Biology project on Charles Darwin."
  },
  {
    name: "William Rees",
    role: "Editor",
    roleLead: 1,
    link: "",
    description: "Year 9 at Ashford School, Academic Scholar, Drama Scholar and Sport Scholar. He enjoys Biology, Geography and swimming, and helped shape the magazine with Jacob."
  },
  {
    name: "Zachary Worden",
    role: "Journalist",
  ...
  { 
    ...
    roleLead: 3,
    link: "",
    description: "A teacher at Ashford School who has supported the magazine with advice and guidance, and contributed to the first issue."
  }
];
